...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white border-t border-gray-200 max-w-screen-2xl mx-auto">
      <div>
        {/* Top Section */}
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-between items-center border-t border-gray-200 pt-4">
          ...
          <div className="flex justify-between space-x-4 mt-4 sm:mt-0 max-w-screen-2xl mx-auto">
